...
export default function SearchSelect(props) {
  ...
  return (
    <div className="ml-2 relative w-full">
      ...
      <div {...getMenuProps()}>
        { isOpen && (
          <ul className="absolute z-10 mt-1 w-full bg-gray-900 shadow-lg max-h-60 rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 overflow-auto focus:outline-none sm:text-sm">
