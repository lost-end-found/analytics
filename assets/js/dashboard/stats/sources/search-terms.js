    ...
    if (this.props.query.filters.goal) {
      ...
      return (
        <div className="text-center text-gray-700 dark:text-gray-300 text-sm mt-20">
          ...
          <div>Read more on <a href="https://analytics.rakun.ie/docs/google-search-console-integration#i-dont-see-google-search-query-data-in-my-dashboard" target="_blank" rel="noreferrer" className="hover:underline text-indigo-700 dark:text-indigo-500">our documentation</a></div>
        </div>
      )
    }
  }
